...
struct text_blob_read_iterator
{
	...
	// head_page_id to start the worm
...
uint32_t read_text_blob_read_iterator(text_blob_read_iterator* tbri, void* data, uint32_t data_size, const void* transaction_id, int* abort_error);
