...
#define NUMERIC_TYPE_PREFIX "numeric"
...
#define GET_NUMERIC_SIGN_BIT_POS_ACC(is_extended) ((is_extended) ? STATIC_POSITION(EXTENDED_PREFIX_POS_VAL, 0) : STATIC_POSITION(0))
...
/*
	...
	Explanation for choosing a 5 byte integer to store 12 decimal digits of information comes from the following logic
		* storing mantissa is a big problem, we need to store group of decimal digits as unsigned integers
