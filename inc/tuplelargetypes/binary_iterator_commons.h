#ifndef BINARY_ITERATOR_COMMONS_H
#define BINARY_ITERATOR_COMMONS_H
...
static inline void point_to_prefix_s_byte(relative_positional_accessor* rpa, uint32_t index, int is_inline)
{
	if(is_inline)
	{
